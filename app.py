...
def resumo_materia(texto_completo):
    prompt = "Sou uma jornalista e estou fazendo uma newsletter com notícias sobre três candidatos para a prefeitura de São Paulo nas eleições de 2024. Estou te apresentando notícias agrupadas por palavras-chave. Cada palavra-chave leva o nome de um candidato. Para cada palavra-chave foram extraídas 5 notícias. Quero que você faça um resumo de no máximo 300 caracteres sobre cada notícia, separadamente. Siga os seguintes passos: 1- Leia as notícias extraídas na função. 2 - Separe trechos importantes que podem ser essenciais para o eleitor se informar sobre o candidato. 3 - Faça um resumo de no máximo 300 caracteres sobre a notícia. 4 - É obrigatório que o resumo tenha o nome do candidato sugerido na palavra-chave. "
